const main = async () => {
    ...
    // const helperContractFactory = await hre.ethers.getContractFactory("RuneHelper")
    // const helperContract = await helperContractFactory.deploy()
    // await helperContract.deployed()

    const ownerContractFactory = await hre.ethers.getContractFactory("PlayerOwnership")
